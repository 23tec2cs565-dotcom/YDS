        ...
        <header className="relative h-[60vh] min-h-[420px] bg-[#0F0F10] text-white flex items-end" role="region" aria-label={`${service.title} hero`}>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 pb-12 w-full">
            <button
              ...
              className="inline-flex items-center gap-2 text-sm text-white/80 hover:text-[#E6B566] backdrop-blur-md px-3 py-2 rounded-full bg-white/5 border border-white/10 mb-8 transition-colors"
            >
