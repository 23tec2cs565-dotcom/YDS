          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-16">
            <div className="md:w-1/2 relative">
               ...
               <div className="grid grid-cols-2 gap-3 sm:gap-4">
                 <img decoding="async" src="/younick-thumb1.webp" width="500" height="500" onError={handleImgError} className="w-full h-40 sm:h-64 object-cover grayscale hover:grayscale-0 transition-all duration-700 rounded-sm" alt="Younick Design Studio team collaborating on a project" title="Younick Design Studio team collaborating on an interior project in Jaipur" loading="lazy" />
                 <img decoding="async" src="/younick-thumb2.webp" width="500" height="500" onError={handleImgError} className="w-full h-40 sm:h-64 object-cover grayscale hover:grayscale-0 transition-all duration-700 rounded-sm translate-y-4 sm:translate-y-8" alt="Younick Design Studio team meeting and planning session" title="Younick Design Studio team meeting and planning session" loading="lazy" />
               </div>
            </div>
